...
public class BoidBehaviors : MonoBehaviour
{
    ...
    public BoidBehaviors pursueTarget;

    public Vector3 pursueTargetPos;

    public bool offsetPursueEnabled = false;
    public BoidBehaviors leader;
    public Vector3 offset;
    private Vector3 worldTarget;
    private Vector3 targetPos;

    public Vector3 Pursue(BoidBehaviors pursueTarget)
    {
    ...
    public Vector3 OffsetPursue(BoidBehaviors leader)
    {
        // This is a bug!!
